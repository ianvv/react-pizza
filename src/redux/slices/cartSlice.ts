...
export const cartItemByIdSelector = (id: number) => (state: RootState) => state.cart.items.find(obj => obj.id === id);

export const {addItem, removeItem, clearItems, decrement, increment} = cartSlice.actions;
